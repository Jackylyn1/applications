...
4. **PROJECTS / FEATURED** — the strong genuine projects (execution system, ExecutionSystem, Sanctum API + CSV, WordPress+React, Laravel Pivot = OSS contribution, AI Engineering), strongest first; no unverified README numbers.
