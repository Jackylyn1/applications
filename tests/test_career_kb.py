...
BASE = {
    ...
    'sections': [
        ...
        },
        {
            ...
            'type': 'experience',
            'items': [
                {'title': 'SigTrader', 'bullets': ['p']},
                {'title': 'NautilusTrader', 'bullets': ['q']},
            ],
        },
    ],
}
...
def test_dropping_a_job_is_flagged_but_dropping_a_project_is_not():
    ...
    _, project_notes = apply_patch(BASE, {'projects': {'select': ['SigTrader']}})
...
def test_projects_addresses_the_second_experience_section():
    doc, _ = apply_patch(BASE, {'projects': {'rewrite': {'SigTrader': {'bullets': ['x']}}}})
