...
Rules for job-application documents only — not for the LinkedIn profile or social media. Inherits universal branding (`general-standards.md`) and voice (`communication-rules.md`). Source: `Application_Standards_and_Career_Guidelines.pdf`.

## Fact source
- Never-invent and the `profile.json`-only rule are universal → `general-standards.md`, *Evidence over claims*.
...
## Output
- Use **info@perfectseowebsite.de** on all generated application documents, never the personal address.
