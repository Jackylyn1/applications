...
letters that both follow them should still read like two different letters. Never reuse a
previous letter as a fill-in-the-blanks form — each one is written for one specific role at
one specific company.

### Format
- **One page maximum (DIN A4).** Nothing spills onto a second page.
- **No enclosures line.** Never end with "Anlage(n): …". The attachments are whatever is actually sent with the application; listing them in the letter adds nothing and goes stale the moment the set of documents changes.

### What every letter must do
- **Don't retell the CV.** The CV lists what she did; the letter explains why that matters for *this* role. If a sentence would work unchanged as a CV bullet, cut it.
- **Open strong.** The first paragraph has to earn the second: lead with the biggest single piece of value she brings here — the company's problem and her relevant answer to it — not with an announcement that she is applying.
...
- Roughly **40% the company / their problem, 40% how she solves it, 20% about her.**
- A flow that usually works: (1) the company's problem or mission; (2) her experience against that need; (3) one or two concrete project examples; (4) the close. Deviate whenever a specific role reads better another way — the weights and the goals above are what count, the sequence is not.
- Reference the specific company or job posting in the **introduction**.

### Before it ships
- Proofread spelling, grammar and punctuation.
- Verify the company name, the recipient and the exact job title from the posting are correct and spelled right.
