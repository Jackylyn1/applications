...
Channel-specific rules for [applicant]'s LinkedIn **profile**. Inherits the
...
- The profile links GitHub, so the repos are part of it. When a repo would damage the impression if someone opened it, say so **and say what to do with it** — archive, set private, or **delete** ([applicant], 2026-07-28). Listing it as "deliberately not included" is not enough; a reader can still find it.
